...
const SAMPLE_DATA: Record<string, string> = {
    ...
    dealName: "Cloud Migration – Acme Corp",
    ...
    reason: "Client requested updated timeline",
    ...
    "opportunity.salesRepName": "Michael Chen",
    "opportunity.managerName": "David Park",
    ...
    "opportunity.geolocation": "Mumbai, India",
...
export const FIELD_CATALOG: { table: string; icon: string; fields: { key: string; label: string; type: string }[] }[] = [
    {
        ...
        fields: [
            ...
            { key: "value", label: "Value (number only)", type: "number" },
            { key: "currency", label: "Currency Code (USD / INR …)", type: "text" },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: "calc:formattedValue", label: "Formatted Value (currency + number)", type: "calc" },
            ...
            { key: "calc:gomPercent", label: "GOM Profitability % (from presales)", type: "calc" },
            { key: "calc:gomAbsolute", label: "GOM Absolute (currency + amount)", type: "calc" },
            { key: "calc:totalRevenue", label: "Total Revenue (from presales)", type: "calc" },
            { key: "calc:totalCost", label: "Total Cost (from presales)", type: "calc" },
        ],
    },
];
