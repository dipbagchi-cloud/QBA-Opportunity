        ...
        <div className="space-y-8 animate-in fade-in duration-500 min-h-screen pb-20">
            ...
            <div className="flex items-center gap-4 border-b border-slate-200 pb-1">
                <button
                    ...
                    className={`px-4 py-2 font-medium border-b-2 transition-colors ${viewMode === 'list'
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium border-b-2 transition-colors ${viewMode === 'kanban'
                        ? 'text-indigo-600 border-indigo-600'
                        : 'text-slate-500 border-transparent hover:text-indigo-600'}`}
                >
                    Kanban Board
                </button>
                <button className="px-4 py-2 text-slate-500 hover:text-indigo-600 font-medium transition-colors border-b-2 border-transparent">By Owner</button>
            </div>
