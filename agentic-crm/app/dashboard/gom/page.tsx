    ...
    return (
        <div className="space-y-4 animate-in fade-in duration-500 min-h-screen pb-8">
            <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Resource effort estimation and cost calculation.</p>
            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm outline-none focus:border-indigo-500"
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm outline-none focus:border-indigo-500"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm outline-none focus:border-emerald-500"
                                    />
                                </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-1.5 bg-slate-50 border rounded-lg text-sm ${workingDays / durationMonths > 22 ? 'border-amber-500 text-amber-700' : 'border-slate-200'}`}
                                />
                            </div>
                        </div>
                            ...
                            <table className="w-full text-xs text-left">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    <tr>
                                        ...
                                        <td className="py-2 px-3 font-mono">{adjustedCost.toLocaleString()}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="py-2 px-3 font-mono font-bold text-indigo-600">{offshoreFinancials.profit.toLocaleString()}%</td>
